...
// 1.获取DOM节点
// 元素（1种）
const div1 = docuent.getElementById('div1')
// 集合（3种）
...
div1.parentNode
// 3.删除节点
divList.removeChild(div1.childNodes[0])
// 4.过滤子元素节点类型为1的节点
const list = Array.property.call(div1.childNodes).filter((child) => {
  if (child.ndoeType === 1) {
    return true
  }
  return false
